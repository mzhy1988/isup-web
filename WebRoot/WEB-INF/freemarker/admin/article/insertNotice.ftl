...
<span>标题：</span>
    ...
    <input  type="text" name="type" id="type"  style="visibility:hidden" value="02"/>
</div>
    <div style=" margin-left:10px; margin-top:10px;">
    <p></p>
     <textarea id="editor" style="width:750px;height:400px;" name="contentfile"></textarea>
    ...
    function getContent() {
     ...
     function check(){
		...
		$.ajax({
			...
			async: false,
			dataType: "json",
			data: {"title" : title,"content":content,"type":"02"},
