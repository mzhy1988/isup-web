				...
				<table  border="1px" bordercolor="#D8D8D8" class="ctab" >
				 ...
				 <div style="margin-top:10px;"> 
				     ...
				     <span style=" float:right; margin-right:5px;"> 
				    	<input id="returnBtn" onclick="workingLog.approveWorkingLog('04');" type="button" value="&nbsp;&nbsp;退&nbsp;回&nbsp;&nbsp;" style="border:0px; background-color:#CCC; width:100px; height:30px; color:#FFF;font-family:'微软雅黑'; font-size:16px;"  >
				     </span>
				 </div>
			</div>
		</div>
