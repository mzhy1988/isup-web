...
<div style="width:1000px; margin:0px auto 0px auto; font-family:'微软雅黑';">
	...
	<div class="rightdiv" id="showPanel">
		...
		<div style="float:right; margin-top:19px; margin-right:50px; font-size:15px; color:#666;">日期
			...
			<#else>
				<input readonly type="text" class="Wdate" id="logTime" onfocus="WdatePicker({dateFmt:'yyyy-MM'})" value="${log.logTime}" style="border-color:#D8D8D8;" />
			</#if>
			<input type="hidden" id="logId" value="${log.id}"/>
			<input type="hidden" id="logStatus" value="${log.logStatus}"/>
			<input type="hidden" id="logType" value="03"/>
		</div>
		<table  style="float:left; margin-top:20px;" border="1px" bordercolor="#D8D8D8">
			...
			<table  border="1px" bordercolor="#D8D8D8" class="ctab">
		        ...
		        <tr style="background-color:#F5F5F5;height:30px;"><td >&nbsp;&nbsp;下月工作计划</td></tr>
		        <tr style="height:200px;">
		        	<td style="text-align:center">
		    ...
		    <span  style=" float:right; margin-right:5px; margin-top:20px; ">
		    	<input type="button" id="monthlySubmit" value="&nbsp;&nbsp;提 &nbsp;交&nbsp;&nbsp;" style="border:0px; background-color:#63ACD9; width:100px; height:30px; color:#FFF;font-family:'微软雅黑'; font-size:16px;">&nbsp;&nbsp;
		        <input type="button" id="monthlySaveDraft" value="保存草稿" style=" background-color:#E3E3E3; width:100px; height:30px; border:0px;font-family:'微软雅黑';font-size:16px; color:#666" >&nbsp;&nbsp;
		        <input type="button" onclick="window.history.back();" value="&nbsp;&nbsp;取&nbsp;&nbsp;消&nbsp;&nbsp;" style="border:0px; background-color:#E3E3E3; width:100px; height:30px;font-family:'微软雅黑';font-size:16px; color:#666"  >
		    </span>
		</div>
	</div>
</div>
