...
public class GenServiceUtil {
	...
	public GenServiceUtil(String tableName) {
		//parseDao(tableName);
	}
	...
	private  String parseDao(String tableName) {
		String packagePath = HelpUtils.getpackagePath(tableName, "service");
		...
		sb.append("  public interface " + HelpUtils.getServiceClassName(tableName) + " {\r\n\r\n");
	...
	public static void main(String[] args) {
		...
		GenServiceUtil dao = new GenServiceUtil(tableName);
